::---------------------------------------------------------::
:: Agile Rgb Windows Build Script                          ::
::                                                         ::
:: Sets up build environment for desired Qt version and    ::
:: build architecture, then builds Agile Rgb                ::
::                                                         ::
:: Prerequisites:                                          ::
::  * Microsoft Visual Studio Build Tools                  ::
::  * Agile Rgb Qt Packages                                 ::
::                                                         ::
:: Adapted from the OpenRGB Windows build script            ::
::---------------------------------------------------------::
...
::---------------------------------------------------------::
move "release" "Agile Rgb Windows %BITS%-bit"
